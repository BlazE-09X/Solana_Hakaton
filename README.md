...
| **Database** | Firebase (Auth & HelpDesk) |
| **Hardware** | Arduino (IoT интеграция) |
...
- [ ] **v1.1 — Security & UI**
  - [ ] Система залоговых депозитов (Escrow) для защиты владельцев.
  - [ ] Автоматическое завершение сессии аренды по таймеру.
  - [ ] Расширенная панель управления (Dashboard) для владельцев активов.

- [ ] **v2.0 — Hardware & IoT Integration**
  - [ ] Интеграция с Arduino для управления физическими объектами (смарт-замки).
  - [ ] Использование датчиков для автоматического подтверждения состояния актива.
  - [ ] Мобильное приложение на Android для управления арендой «на ходу».
  ---
